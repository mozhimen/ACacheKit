package com.mozhimen.cachek.serial.helpers
 ...
 * @Version 1.0
 */
class SerialProvider(private val _encodeName: String) : ISerialProvider {
    /**
     * 生成6位流水号，如：000001
     * @return
     */
    ...
    fun getCodeOfSix(nowNum: Long): String {
        ...
        return UtilKStringsJVMWrapper.format_fill_sta_0(count.get(), 6)
    }
